  ...
  return (
    <div className={styles.adminContainer}>
      <nav className={styles.navbar}>
        <button className={styles.menuToggle} onClick={() => setMenuAbierto(!menuAbierto)} aria-label="Menú">
          ☰
        </button>
        <div className={`${styles.navLinks} ${menuAbierto ? styles.navLinksOpen : ""}`}>
          <a href="/menu">Menu</a>
          <Link to="/portal">Portal</Link>
        </div>
        <div className={styles.navLogo}>
          <img src="src/assets/Logos/Favicon3.ico" alt="Logo Niquel" />
        </div>
      </nav>
      ...
      {modalEliminarAbierto && usuarioAEliminar && (
        <div className={styles.modalOverlay} onClick={() => setModalEliminarAbierto(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalBody}>
              <p>¿Estás seguro de eliminar al usuario <strong>{usuarioAEliminar.nombre}</strong>?</p>
            </div>
            <div className={styles.modalFooter}>
